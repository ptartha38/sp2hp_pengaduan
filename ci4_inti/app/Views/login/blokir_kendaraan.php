...
<head>
  ...
  <title>Perysaratan Blokir Kendaraan</title>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 d-flex flex-column justify-content-center">
          <h1 data-aos="fade-up">Persyaratan Pembuatan Blokir Kendaraan</h1>
          <p data-aos="fade-up" data-aos-delay="400">1. Fotocopy Kartu Tanda Penduduk</p>
          <p data-aos="fade-up" data-aos-delay="400">2. Fotocopy STNK</p>
          <p data-aos="fade-up" data-aos-delay="400">3. Fotocopy BPKB / Surat Keterangan Kepemilikan BPKB</p>
          <p data-aos="fade-up" data-aos-delay="400">4. Fotocopy TANDA BUKTI LAPOR (TBL)</p>
          <b>
            <p data-aos="fade-up" data-aos-delay="400">Semua Berkas Fotocopy Rangkap 2</p>
          </b>
        </div>
        <div class="col-lg-6 hero-img" data-aos="zoom-out" data-aos-delay="200">
          <img src="<?= base_url() ?>/tema/assets/img/blokir.png" class="img-fluid" alt="">
        </div>
      </div>
    </div>
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-2 col-6 footer-links">
            ...
            <ul>
              ...
              <li><i class="bi bi-chevron-right"></i> <a href="#">Pembuatan Blokir Kendaraan Bermotor</a></li>
            </ul>
          </div>
