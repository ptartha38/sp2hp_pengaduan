...
<head>
    ...
    <title>Perysaratan Pembuatan Kehilangan STNK / BPKB</title>
...
<body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 d-flex flex-column justify-content-center">
                    <h1 data-aos="fade-up">Perysaratan Pembuatan Kehilangan STNK / BPKB</h1>
                    <p data-aos="fade-up" data-aos-delay="400">1. Surat Laporan Kehilangan dari SPKT</p>
                    <p data-aos="fade-up" data-aos-delay="400">2. Cek Fisik Kendaraan</p>
                    <p data-aos="fade-up" data-aos-delay="400">3. STNK</p>
                    <p data-aos="fade-up" data-aos-delay="400">4. KTP</p>
                    <p data-aos="fade-up" data-aos-delay="400">5. Surat Broadcast dari Media</p>
                    <p data-aos="fade-up" data-aos-delay="400">6. Surat Keterangan dari Bank, Koperasi, Pegadaian dll (Untuk Hilang BPKB)</p>
                    <b>
                        <p data-aos="fade-up" data-aos-delay="400">Semua Berkas di Fotocopy</p>
                    </b>
                </div>
                <div class="col-lg-6 hero-img" data-aos="zoom-out" data-aos-delay="200">
                    <img src="<?= base_url() ?>/tema/assets/img/kehilangan.png" class="img-fluid" alt="">
                </div>
            </div>
        </div>
    ...
    <footer id="footer" class="footer">
            ...
            <div class="container">
                <div class="row gy-4">
                    ...
                    <div class="col-lg-2 col-6 footer-links">
                        ...
                        <ul>
                            <li><i class="bi bi-chevron-right"></i> <a href="#">Pembuatan Kehilangan STNK / BPKB</a></li>
        ...
        <div class="container">
            <div class="copyright">
                Copyright &copy; <strong><span>2021 Satreskrim Polres Sumbawa</span></strong>. All Rights Reserved
            </div>
        </div>
    </footer><!-- End Footer -->
